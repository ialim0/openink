  ...
  const Biography = () => (
    <section className="mt-8 max-w-3xl mx-auto">
      <article className="space-y-6">
        ...
        <p className={styles.text}>
          I've had the chance to work on projects with teams from the US, France, and Australia . While I'm still learning, this experience has introduced me to different aspects of AI, from basic machine learning concepts to how AI integrates with other systems.
        </p>
        <p className={styles.text}>
