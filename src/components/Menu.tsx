...
const Menu: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full shadow-lg bg-gray-50 text-gray-800 font-sans">
            ...
            <div className={`p-6 bg-white rounded-lg shadow-md mt-6 ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
            ...
            <div className={`flex-grow overflow-y-auto ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
